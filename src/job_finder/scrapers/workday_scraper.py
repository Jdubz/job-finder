...
class WorkdayScraper(BaseScraper):
    ...
    def parse_job(self, job_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # Extract job requisition (for keywords)
            job_requisition = job_data.get("externalPath", "")
            ...
            job = {
                ...
                "salary": "",  # Workday typically doesn't include salary in API
                "keywords": [job_requisition] if job_requisition else [],
            }
